      ...
      <header className="pointer-events-auto flex justify-between items-center transition-all duration-300 bg-cream/95 backdrop-blur-md border border-[#3b2b24]/10 shadow-lg rounded-2xl px-6 py-3 w-full max-w-6xl">
        ...
        <nav className="hidden md:flex gap-6 items-center">
          ...
          <Link 
            to="/dinner" 
            onClick={handleScrollTop} 
            className="group ml-6 px-9 py-3 rounded-md font-heading uppercase not-italic font-bold text-xl tracking-wider bg-[var(--accent-primary)] text-white hover:bg-[var(--text-main)] hover:scale-105 active:bg-[var(--text-main)] active:scale-95 shadow-md transition-all duration-300 flex items-center justify-center min-w-[130px]"
          >
