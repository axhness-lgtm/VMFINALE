    ...
    <footer className="w-full bg-[var(--bg-primary)] border-t border-[var(--text-main)]/10 py-16 px-6 relative overflow-hidden">
      <div className="container mx-auto max-w-6xl relative z-10 flex flex-col items-center text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-10 font-body italic text-xl md:text-2xl text-[var(--text-main)]/80 mb-12">
          <Link to="/dinner" onClick={handleScrollTop} className="hover:text-[var(--accent-primary)] transition-colors">Dinners</Link>
          <Link to="/about" onClick={handleScrollTop} className="hover:text-[var(--accent-primary)] transition-colors">Story</Link>
          <Link to="/journal" onClick={handleScrollTop} className="hover:text-[var(--accent-primary)] transition-colors">Journal</Link>
          <Link to="/community" onClick={handleScrollTop} className="hover:text-[var(--accent-primary)] transition-colors">Community</Link>
        </div>
